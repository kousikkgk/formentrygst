...
public class Sales {
	...
	public String toString() {
		return "Sales [id=" + id + ", inv_no=" + inv_no + ", date=" + date + ", loclaDate=" + loclaDate
				+ ", party_name=" + party_name + ", gst_no=" + gst_no + ", tax_val=" + tax_val + ", tax_per=" + tax_per
				+ ", cgst_val=" + cgst_val + ", sgst_val=" + sgst_val + ", total=" + total + ", state=" + state
